...
public class TextPadDAOImpl implements TextPadDAO {
	...
	RowMapper<TextPad> textPad = (rs, rowNum) -> {
	...
	public List<TextPad> getAllTexts() {
		...
		List<TextPad> result = namedParameterJdbcTemplate.query(sql, params, textPad);
	...
	public TextPad getTextById(int id) {
		...
		TextPad result = namedParameterJdbcTemplate.queryForObject(sql, params, textPad);
		return result;
	}
	...
	public void deleteText(int id) {
		String delete = "Delete from textpad where id = :id";
